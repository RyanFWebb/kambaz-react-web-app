...
export default function WorkingWithArrays() {
    ...
    return (
        <div id="wd-working-with-arrays">
            ...
            <br /><br /><hr />
            <h4>Updating the Description in an Array</h4>
            ...
            <br /><br />
            <h4>Updating the Completion Status in an Array</h4>
            <a href={`${API}/${todo.id}/completed/${todo.completed}`} className="btn btn-primary float-end">
                Update Completion Status</a>
            <FormControl defaultValue={todo.id} className="w-25 float-start me-2"
                onChange={(e) => setTodo({ ...todo, id: e.target.value })}/>
            <FormCheck type="checkbox" label="Check if Completed"
                checked={todo.completed} className="w-50 float-start"
