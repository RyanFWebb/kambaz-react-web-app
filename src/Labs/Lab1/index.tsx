...
tag to tell browsers to render the gaps.
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    <li>In a sauce pan, melt ~half a stick of butter to start bechamel sauce.</li>
                    <li>Add in 1/4 cup of flour and whisk to combine.</li>
                    <li>Slowly add in 2 1/2 cups of milk so that the mixture does not burn but remains thick.</li>
                    <li>Add salt and pepper to taste.</li>
                    <li>In a separate pan, caramelize 1/2 to a full onion.</li>
                    <li>Add ground beef with Italian seasoning.</li>
                    <li>Once cooked, add your favorite tomato sauce.</li>
                    <li>Boil 9 lasagna noodles.</li>
                    <li>In a rectangular casserole dish, add layers of 3 noodles, meat sauce, bechamel sauce, 
                    then top with shredded mozzarella and parmesan.</li>
                    <li>Repeat until you run out of ingredients.</li>
                    <li>Bake in oven at 350 degrees F for 40-50 minutes.</li>
                ...
                <ul id="wd-your-books">
                    ...
                    <li>Inventology</li>
                    <li>The Age of Living Machines: How Biology Will Build the Next Technology Revolution</li>
                </ul>
            </div>
            <div id="wd-tables">
                <h4>Table Tag</h4>
            ...
            <div id="wd-forms">
                ...
                <form id="wd-text-fields">
                    ...
                    <input type="email" placeholder="@northeastern.edu"
                        value="webb.ry@northeastern.edu"
                        title="Email"
                        id="wd-text-fields-email" />
                    <br />
                    <label htmlFor="wd-text-fields-nuid">NU ID:</label>
                    <input type="text" 
                        value="123456789"
                        title="NU ID"
                        id="wd-text-fields-nuid" />
                </form>
            </div>
            ...
            <h4>Anchor tag</h4>
            Please  <a href="https://github.com/RyanFWebb/kambaz-react-web-app" id="wd-github">click here</a> to get the code repository on GitHub for this page.<br/>
        </div>
    );
}